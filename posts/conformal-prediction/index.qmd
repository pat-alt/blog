...
function contourf_setsize(mach::Machine, x1_range, x2_range)
    set_size = []
    proba = []
    ...
    plt = contourf(x1_range, x2_range, proba, alpha=0.5)
    # contour!(plt, x1_range, x2_range, set_size)
    return plt
end
```
